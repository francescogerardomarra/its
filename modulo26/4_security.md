...
To implement a maximum session length (not just an inactivity timeout), **Spring Security does not provide a built-in way to enforce a session expiration after a fixed duration, regardless of user activity**.
